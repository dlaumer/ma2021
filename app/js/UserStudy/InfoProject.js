...
define([
    ...
    return Accessor.createSubclass({
        ...
        init: function () {
            ...
            as the visualizations are optimized for larger screens<br>
            ...
            investigators will have access to the original data under 
            ...
            from the public and the green parties. Other arguments against it were the immense costs 
            ...
            (Please note that some of the provided data is only generated for the porpose of this study and does not always reflect the reality!)<br><br>

            <h3>Contact information</h3>
            Author: Daniel Laumer, laumerd@ethz.ch, dlaumer@esri.com<br>
